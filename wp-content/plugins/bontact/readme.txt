...
https://www.youtube.com/watch?v=95YqlkZTVv8
...
== Changelog ==
= 1.2.1 =
* Brand NEW design. Interface changes for easier access to multiple channels. Better and faster performance. Bug fixes

= 1.2.0 =
* Fix: Fixed the issue with registeration with advanced passwords 

= 1.1.9 =
* Fix: Signup Form Validation

= 1.1.8 =
* Fix: Dashboard visitor browser indication
